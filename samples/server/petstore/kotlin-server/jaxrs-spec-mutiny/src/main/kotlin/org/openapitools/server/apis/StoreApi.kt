...
interface StoreApi {
    ...
    fun deleteOrder(@PathParam("") orderId: kotlin.String): io.smallrye.mutiny.Uni<Response>
    ...
    fun getOrderById(@PathParam("") orderId: kotlin.Long): io.smallrye.mutiny.Uni<Response>
